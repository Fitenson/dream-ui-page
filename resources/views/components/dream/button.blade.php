...
@php
    ...
    $variantClasses = match($variant) {
        ...
        default => 'bg-current text-white hover:bg-opacity-90 text-center',
    };

    // Combine base + variant classes + common classes
    $classes = trim("inline-flex text-center items-center cursor-pointer text-sm sm:text-base px-3 sm:px-4 py-2 sm:py-3 font-medium rounded $theme $variantClasses");
@endphp
